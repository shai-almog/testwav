 ...
 * @author Shai Almog
 */
public class TestWavStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "TestWav";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new TestWavStub());
    }
